  ...
  return (
    <div className="p-6 bg-[#F2F2F0] min-h-screen">
        ...
        <tbody>
          {perritos.map((perrito) => (
            <tr key={perrito.id} className="text-center bg-white border-b">
              ...
              <td>
                <button className="text-[#2A5559] hover:text-black">
      ...
      <div className="mt-4 text-center">
        <span className="cursor-pointer mx-2 text-[#2A5559] hover:underline">
          1
        </span>
        <span className="mx-2 cursor-pointer hover:underline">2</span>
        <span className="mx-2 cursor-pointer hover:underline">3</span>
